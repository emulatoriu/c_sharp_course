    ...
    public class ToolBarButton : Button {
        ...
        static ToolBarButton() {
            ...
            DisplayStyleProperty    = DependencyProperty.RegisterAttached("DisplayStyle",
                                                                         ...
                                                                         typeof(ToolBarButton),
                                                                         new FrameworkPropertyMetadata(TBDisplayStyle.Text,
        ...
        private void UpdateInnerButton() {
            ...
            strText       = Text;
            if (Image != null && (eDisplayStyle == TBDisplayStyle.Image || eDisplayStyle == TBDisplayStyle.ImageAndText)) {
            ...
            if (!String.IsNullOrEmpty(strText) && (eDisplayStyle == TBDisplayStyle.Text || eDisplayStyle == TBDisplayStyle.ImageAndText)) {

...
namespace SrcChess2 {
    ...
    public class PgnGame {
        ...
        public PgnGame(bool createAttrList, bool createMoveList) {
            Attrs       = createAttrList ? new Dictionary<string, string>(10) : null;
        ...
        public int WhiteELO {
            get {
                if (Attrs != null && (m_attrRead & AttrRead.WhiteELO) == 0) {
                    ...
                    if (!Attrs.TryGetValue("WhiteElo", out string? txtValue) || !Int32.TryParse(txtValue, out m_whiteELO)) {
                        m_whiteELO = -1;
                    }
                }
                return (m_whiteELO);
        ...
        public int BlackELO {
            get {
                if (Attrs != null && (m_attrRead & AttrRead.BlackELO) == 0) {
                    ...
                    if (!Attrs.TryGetValue("BlackElo", out string? txtValue) || !Int32.TryParse(txtValue, out m_blackELO)) {
                        m_blackELO = -1;
                    }
                }
                return (m_blackELO);
        ...
        private void InitPlayerSpan() {
            ...
            if (timeControl != null) {
                ...
                if (timeControls.Length == 3                        &&
                    timeControls[0] == "?"                          &&
                    Int32.TryParse(timeControls[1], out int tick1)  &&
                    Int32.TryParse(timeControls[2], out int tick2)) {

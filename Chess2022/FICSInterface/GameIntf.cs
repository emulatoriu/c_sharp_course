...
namespace SrcChess2.FICSInterface {
    ...
    public class GameIntf {
        ...
        private readonly Action<GameIntf,TerminationCode,string>?   m_gameFinishedAction;
        ...
        public GameIntf(FICSGame                                 game,
                        ...
                        Action<GameIntf,TerminationCode,string>? gameFinishedAction) {
            Game                    = game;
            ...
            m_initialMoveList       = new List<SrcChess2.MoveExt>(128);
        ...
        private void SetBoardControl() {
            void del() {
                ChessBoardCtl.CreateGameFromMove(null /*chessBoardStarting*/,
                                                 m_initialMoveList,
                                                 m_chessBoard.CurrentPlayer,
                                                 Game.WhitePlayerName,
                                                 Game.BlackPlayerName,
                                                 SrcChess2.PgnPlayerType.Human,
                                                 SrcChess2.PgnPlayerType.Human,
                                                 TimeSpan.Zero,
                                                 TimeSpan.Zero);

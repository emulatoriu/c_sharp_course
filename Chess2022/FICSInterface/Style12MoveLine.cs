...
namespace SrcChess2.FICSInterface {
    ...
    public class Style12MoveLine {
        ...
        public ChessBoard.PieceType[]       Board { get; private set; }
        ...
        static public TerminationCode IsMoveTermination(string line, out int gameId, out string terminationComment, out string? errTxt) {
            ...
            if (line.StartsWith("{Game ")) {
                parts = line.Split(' ');
                if (Int32.TryParse(parts[1], out gameId)) {
                    switch (parts[^1]) {
                    case "1/2-1/2":
            ...
            } else if (line.StartsWith("Removing game ") && Int32.TryParse(line.Split(' ')[2], out gameId)) {
                retVal = TerminationCode.Terminated;
            }
            return(retVal);
        }
                    ...
                    if (errTxt == null) {
                        ...
                        if (errTxt == null) {
                            if (!retVal.SetBoardStateMask(parts[11], ChessBoard.BoardStateMask.WRCastling) ||
                                ...
                                !Int32.TryParse(parts[15], out intVals[0])                                 ||
                                !Int32.TryParse(parts[16], out intVals[1])                                 ||
                                !Int32.TryParse(parts[19], out intVals[2])                                 ||
                                !Int32.TryParse(parts[20], out intVals[3])                                 ||
                                !Int32.TryParse(parts[21], out intVals[4])                                 ||
                                !Int32.TryParse(parts[22], out intVals[5])                                 ||
                                !Int32.TryParse(parts[23], out intVals[6])                                 ||
                                !Int32.TryParse(parts[24], out intVals[7])                                 ||
                                !Int32.TryParse(parts[25], out intVals[8])                                 ||
                                !Int32.TryParse(parts[26], out intVals[9])                                 ||
                                !Int32.TryParse(parts[30], out intVals[10])) {
                        ...
                        if (errTxt == null) {
                            if (parts.Length >= 33                         &&
                                Int32.TryParse(parts[31], out intVals[0])  &&
                                Int32.TryParse(parts[32], out intVals[1])) {

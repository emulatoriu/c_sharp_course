...
namespace SrcChess2 {
    ...
    public class MoveExt {
        ...
        /// </summary>
        /// <param name="move">             Base move</param>
        public MoveExt(Move move) : this(move, comment: "", permutationCount: 0, searchDepth: 0, cacheHit: 0, nagCode: 0) {}
        ...
        /// NAG Description
        /// </summary>
        public string NAGDescription => m_arrNag[m_iNag];
